    ...
    <main>
      <section className="hero">
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:.7}}>
          <div className="eyebrow"><Sparkles size={16}/> Candidate profile for OpenAI Head of People Science & Operations</div>
      ...
      <section id="fit" className="section two-col">
        <div><div className="kicker">Role fit</div><h2>What OpenAI gets</h2><p className="section-lead">A people systems leader who can operate with technical credibility, executive range, and the pattern recognition of someone who has scaled a generational company before.</p></div>
      ...
      <section id="experience" className="section">
        <div className="kicker">Selected experience</div><h2>Proof across OpenAI-relevant moments</h2>
      ...
      <section id="ideas" className="section two-col dark-card">
        <div><div className="kicker">Operating philosophy</div><h2>The next organization will not scale through headcount alone.</h2><p>It will scale through systems, judgment, AI augmentation, leadership infrastructure, and human capability design.</p></div>
